...
def generate_launch_description():
    ...
    pkg_trackday = FindPackageShare('trackday')
    default_rviz_config_path = PathJoinSubstitution([pkg_trackday, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the trackday package
